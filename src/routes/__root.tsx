...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "2GW0yU5dDKejUWY_X-GZ3fZfZ53koWmNAJhmmOgYW_k" },
      { name: "description", content: "Expert eyebrow threading, waxing, facials, henna and eyelash services in Wayne, NJ. Call (973) 321-8374 or 551-301-3894 to book." },
      ...
      { property: "og:description", content: "Expert eyebrow threading, waxing, facials, henna and eyelash services in Wayne, NJ. Call (973) 321-8374 or 551-301-3894 to book." },
      { name: "twitter:description", content: "Expert eyebrow threading, waxing, facials, henna and eyelash services in Wayne, NJ. Call (973) 321-8374 or 551-301-3894 to book." },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&family=Great+Vibes&display=swap" },
      {
        rel: "stylesheet",
        href: appCss,
      },
    ...
    scripts: [
      ...
      {
        children:
          "window.dataLayer = window.dataLayer || [];function gtag(){dataLayer.push(arguments);}gtag('js', new Date());gtag('config', 'G-5MM3ZFDTG2');",
      },
      {
