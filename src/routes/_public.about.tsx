  ...
  return (
    <>
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            ...
            <h1 className="font-serif text-5xl md:text-6xl mb-6 leading-tight">Timeless beauty, <span className="gradient-text-gold">Style of India.</span></h1>
          ...
          <div className="rounded-[2rem] overflow-hidden gold-border shadow-lift p-1">
            <img src={salonImg} alt="SOI Threading Salon interior" className="w-full h-[520px] object-cover rounded-[2rem]" loading="lazy" width={1600} height={1000} />
          </div>
        </div>
      </section>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 text-center">
        ...
        <h2 className="font-serif text-4xl md:text-5xl mb-6">Look refreshed. Feel confident. <span className="gradient-text-gold">Radiate naturally.</span></h2>
