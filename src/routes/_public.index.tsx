    ...
    <>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-up">
            <p className="font-script text-3xl md:text-4xl text-gold mb-3">Style of India</p>
            ...
            <p className="mt-6 text-lg text-muted-foreground max-w-xl leading-relaxed">
              Experience expert threading, advanced skin care, waxing, hair care, henna, and timeless beauty services in Wayne, NJ.
            </p>
            ...
            <div className="mt-10 flex items-center gap-2 text-xs uppercase tracking-[0.3em] text-gold-deep">
              <span>Threading</span><span>·</span><span>Facials</span><span>·</span><span>Waxing</span><span>·</span><span>Hair Care</span><span>·</span><span>Henna</span>
            </div>
          </div>

          <div className="relative animate-fade-up" style={{ animationDelay: "0.15s" }}>
            <div className="relative rounded-[2rem] overflow-hidden shadow-lift gold-border p-1">
              <img src={heroImg} alt="Premium beauty care at SOI Threading Salon" className="w-full h-[520px] object-cover rounded-[2rem]" width={1600} height={1200} />
            </div>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {FEATURES.map((f, i) => (
            <div key={f.title} className="card-3d glass-panel rounded-2xl p-7 text-center animate-fade-up" style={{ animationDelay: `${i * 0.08}s` }}>
      ...
      {/* LOYALTY CARD */}
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="rounded-[2rem] gradient-cream gold-border p-8 md:p-14 shadow-card text-center relative overflow-hidden">
          <div className="absolute -top-20 -right-20 w-60 h-60 rounded-full bg-[var(--gold)]/10 blur-3xl" />
          <p className="font-script text-3xl text-gold mb-2">Loyalty Card</p>
          <h2 className="font-serif text-3xl md:text-4xl mb-4">Complete 9 Eyebrow Visits, Get the 10th <span className="gradient-text-gold">FREE</span></h2>
          <p className="text-muted-foreground max-w-xl mx-auto mb-8">Our way of saying thank you for being part of the SOI family.</p>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="rounded-[2rem] glass-panel gold-border p-8 md:p-12 text-center">
